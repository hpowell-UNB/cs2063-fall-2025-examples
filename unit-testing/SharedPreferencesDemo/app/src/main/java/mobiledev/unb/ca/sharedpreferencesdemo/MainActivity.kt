...
import mobiledev.unb.ca.sharedpreferencesdemo.persistence.SharedPreferencesManager
import mobiledev.unb.ca.sharedpreferencesdemo.persistence.getAppSharedPreferences
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initSharedPreferences() {
        SharedPreferencesManager.init(applicationContext.getAppSharedPreferences())
    }
